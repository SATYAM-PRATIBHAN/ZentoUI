...
export default function AnimatedButton({ titleOne, titleTwo }: ButtonProps) {
  return (
    <div className="flex items-center justify-center px-4">
      <RotatingButton>
        <div className="group relative flex cursor-pointer items-center gap-2 rounded-lg bg-black px-5 py-2.5 text-white shadow-lg transition-all duration-300 ease-in-out sm:rounded-xl sm:px-6 sm:py-3">
